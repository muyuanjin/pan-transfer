...
import { ERROR_MESSAGES, LOGIN_REDIRECT_COOLDOWN, LOGIN_REQUIRED_ERRNOS } from './constants'
...
export function maybeHandleLoginRequired(
  errno: number | string | null | undefined,
  context = '',
): boolean {
